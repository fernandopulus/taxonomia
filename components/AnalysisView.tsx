  ...
  return (
    <div className="bg-white shadow-xl rounded-lg p-6 space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-slate-200 pb-4 mb-4">
        <div>
            <h2 className="text-2xl font-bold text-blue-700">{analysis.instrumentTitle}</h2>
        ...
        <div className="flex gap-2">
            <button
                ...
                className="px-4 py-2 text-sm font-medium text-blue-600 bg-blue-100 hover:bg-blue-200 rounded-md shadow-sm flex items-center gap-2"
      ...
      <details className="mt-4 bg-slate-50 p-3 rounded shadow">
        <summary className="text-sm font-medium text-slate-600 cursor-pointer hover:text-blue-600">Ver texto original del instrumento</summary>
